...
const Contact = () => {
    ...
    return (
        <div className='w-full px-[12%] py-10 scroll-mt-20 min-h-screen 
        bg-[url("/footer-bg-color.png")] bg-no-repeat bg-[length:90%_auto]' id='contact'>
            ...
            <form className='max-w-2xlmx-auto' onSubmit={onSubmit}>
