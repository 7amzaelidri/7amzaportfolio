        ...
        <div>
            ...
            <nav
                className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 transition-colors duration-300
                    ${isScroll
                        ? isDarkMode
                            ? "bg-darkNav text-white shadow-md"
                            : "bg-white text-black bg-opacity-50 backdrop-blur-lg shadow-md"
                        : isDarkMode
                            ? "bg-darkNav text-white"
                            : "bg-transparent text-black"
                    }`}
            >
                <a href="#top" >
                    <div className='w-28 cursor-pointer text-2xl mr-14'>7amza <span className='text-4xl text-red-700'>.</span></div>
                </a>
